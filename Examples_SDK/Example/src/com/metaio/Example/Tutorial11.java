...
public class Tutorial11 extends ARViewActivity
{
	...
	protected void loadContents()
	{
		try
		{
			final String trackingConfigFile = AssetsManager.getAssetPath("Tutorial11/TrackingData_MarkerlessFast.xml");
			...
			final String modelPath = AssetsManager.getAssetPath("Tutorial11/metaioman.md2");
			if (modelPath != null)
			{
			...
			final String shaderMaterialsFile = AssetsManager.getAssetPath("Tutorial11/shader_materials.xml");
			...
			{
				if (mModel != null)
					mModel.setShaderMaterial("tutorial11");
			}
