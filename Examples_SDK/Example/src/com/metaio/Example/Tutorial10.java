...
public class Tutorial10 extends ARViewActivity
{
	...
	{
		final String modelPath = AssetsManager.getAssetPath("Tutorial10/Assets10/sphere_10mm.obj");
		if (modelPath != null)
		{
	...
	protected void loadContents()
	{
		try
		{
			final String trackingConfigFile = AssetsManager.getAssetPath("Tutorial10/Assets10/TrackingData_MarkerlessFast.xml");
			...
			final String modelPath = AssetsManager.getAssetPath("Tutorial10/Assets10/cube_50mm.obj");
			if (modelPath != null)
			{
