...
{    
	...
	/**
	 * Determine if metaio SDK should enable background processing thread.
	 * Override this method to change the default behavior.
	 * @return true if background processing thread should be enabled
	 */
	protected boolean shouldEnableBackgroundProcessing()
	{
		return (SystemInfo.getNumCPUCores() > 1);
	}
	...
	public void onCreate(Bundle savedInstanceState) 
	{
		...
		try
		{
			...
			if (shouldEnableBackgroundProcessing())
			{
				MetaioDebug.log("ARViewActivity: background processing enabled");
